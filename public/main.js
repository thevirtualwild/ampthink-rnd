$(function() {
  ...
  var $changeRoomButton = $('.changeRoom'); // Change Room Button
  ...
  function joinRoom () {
    roomname = cleanInput($passcodeInput.val().trim());
    ...
    if (roomname) {
      ...
      $(document).prop('title', 'Chatting on - ' + roomname);
    }
  }
  ...
  // Focus input when clicking anywhere on the roomchange page
  ...
  socket.on('login', function (data) {
    ...
    var message = "Welcome to Socket.IO Chat – you are in room " + roomname;
    log(message, {
      prepend: true
    });
  ...
  socket.on('change room', function(data) {
    ...
    var message = "Welcome to Room - " + roomname;
    log(message, {
      prepend: false
    });
